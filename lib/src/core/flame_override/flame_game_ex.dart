...
import 'package:flame_spatial_grid/src/core/flame_override/component_tree_root_ex.dart';
...
class FlameGameEx<W extends World> extends ComponentTreeRootEx
    with Game
    implements ReadOnlySizeProvider, FlameGame<W> {
  FlameGameEx({
    super.children,
    W? world,
    ...
    if (kDebugMode) {
      DevToolsService.initWithGame(this as FlameGame);
    }
